package Characters 
{
	...
	public class PeachCharacter extends ppppuCharacter 
	{
		...
		public function PeachCharacter() 
		{
			...
			m_diamondColor1 = UtilityFunctions.GetColorUintFromRGB(255, 225, 227);
			m_diamondColor2 = UtilityFunctions.GetColorUintFromRGB(254,194,199);
			m_diamondColor3 = UtilityFunctions.GetColorUintFromRGB(253,159,167);
